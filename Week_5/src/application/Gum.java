...
public class Gum extends Snack{
	...
	Gum(String name, double price, String image, int quantity, double height, double weight, double width, String brand, String flavor, int pieces){
		super(name,price,image,quantity,height,weight,width);
		this.brand = brand;
		this.flavor = flavor;
		this.pieces = pieces;
	}
